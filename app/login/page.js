    ...
    return (
        ...
        <div className='max-h-screen'>
            ...
            <div className="flex flex-col gap-3 justify-center items-center p-10">
                ...
                {/* github  */}
                <button
                    className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-base w-[310px] justify-center font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" onClick={() => signIn("github")}>
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
